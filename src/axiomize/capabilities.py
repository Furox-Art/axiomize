...
def get_capabilities() -> dict[str, Any]:
    ...
    return {
        ...
        "consumption_guard": _cap(True, guarded_actions=[
            ...
            "multiphysics_cosimulation", "surrogate_training_data_generation",
        ]),
        "model_ir": _cap(
        ...
        "surrogate_modeling": _cap(
            True,
            native_methods=["polynomial_response_surface"],
            training_design=["supplied_data", "latin_hypercube_full_model_generation"],
            full_model_generation_requires_approval=True,
            untouched_holdout_validation=True,
            extrapolation_blocked_by_default=True,
        ...
        "model_export": _cap(
            True,
            native=["json", "python", "ipynb", "sbml-l3v2", "cellml-2.0"],
            optional=["yaml"],
            conservative_unversioned_aliases=["sbml", "cellml"],
